...
from agents.solana import solana_agent

# async def solana_stream_internal(
#     request: Request,
#     payload: dict,
# ) -> StreamingResponse:
...
@router.post("/solana/")
async def solana_stream(request: Request, payload: dict = Depends(validate_token)) -> StreamingResponse:
